...
// 이지판매재고관리 원본 데이터 복제
const ORIGINAL_DATA: CollectionItem[] = [
  {
    id: "1",
    date: "2025-12-05",
    slipNo: "C20251205-001",
    customerCode: "c001",
    customerName: "테스트사업장",
    paymentMethod: "현금",
    amount: 100000,
...
export function CollectionStatement() {
  ...
  const [data] = useState<CollectionItem[]>(ORIGINAL_DATA);
  ...
  return (
    <div className="flex h-full flex-col bg-gray-100">
      ...
      <div className="flex items-center justify-between border-b bg-gradient-to-r from-blue-600 to-blue-400 px-3 py-1">
        <span className="text-sm font-medium text-white">수금명세서</span>
      </div>
