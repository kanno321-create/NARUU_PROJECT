...
// 이지판매재고관리 원본 데이터 복제
const ORIGINAL_DATA: LedgerDetailItem[] = [
  {
    id: "1",
    date: "2025-12-05",
    productCode: "e0001",
...
export function CustomerLedgerDetail() {
  ...
  const [customerSearch, setCustomerSearch] = useState("테스트사업장");
  const [data] = useState<LedgerDetailItem[]>(ORIGINAL_DATA);
  ...
  return (
    <div className="flex h-full flex-col bg-gray-100">
      ...
      <div className="flex items-center justify-between border-b bg-gradient-to-r from-blue-600 to-blue-400 px-3 py-1">
        <span className="text-sm font-medium text-white">거래처원장(상세)</span>
      </div>
