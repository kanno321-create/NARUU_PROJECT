...
// 이지판매재고관리 원본 데이터 복제
const ORIGINAL_DATA: ProductSalesItem[] = [
  {
    id: "1",
    productCode: "e0001",
    productName: "핸드폰케이스",
...
export function SalesByProduct() {
  ...
  const [data] = useState<ProductSalesItem[]>(ORIGINAL_DATA);
  ...
  const totals = filteredData.reduce(
    (acc, item) => ({
      ...
      salesAmount2: acc.salesAmount2 + item.salesAmount2,
  ...
  return (
    <div className="flex h-full flex-col bg-gray-100">
      ...
      <div className="flex items-center justify-between border-b bg-gradient-to-r from-blue-600 to-blue-400 px-3 py-1">
        <span className="text-sm font-medium text-white">상품별매출현황</span>
      </div>
        ...
        <table className="w-full border-collapse text-xs">
          <thead className="sticky top-0 bg-[#E8E4D9]">
            <tr>
              ...
              <th className="border border-gray-400 px-2 py-1 w-16">견입품수량</th>
              <th className="border border-gray-400 px-2 py-1 w-16">견입품이익</th>
              ...
              <th className="border border-gray-400 px-2 py-1 w-24">매출수량합계</th>
              <th className="border border-gray-400 px-2 py-1 w-24">매출이익합계</th>
          ...
          <tbody>
            {filteredData.map((item) => (
              ...
              >
                ...
                <td className="border border-gray-300 px-2 py-1 text-right">
                  {item.salesAmount2.toLocaleString()}
                </td>
                <td className="border border-gray-300 px-2 py-1 text-right">
            ...
            <tr className="bg-gray-200 font-medium">
              ...
              <td className="border border-gray-400 px-2 py-1 text-right">
                {totals.salesAmount2.toLocaleString()}
              </td>
              <td className="border border-gray-400 px-2 py-1 text-right">
