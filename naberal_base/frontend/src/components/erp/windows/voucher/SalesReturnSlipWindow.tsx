...
export function SalesReturnSlipWindow() {
        ...
        <div className="flex h-full flex-col">
            ...
            <div className="flex-1 overflow-auto p-4">
                <div className="space-y-4">
                    <div className="rounded-lg border border-orange-200 bg-orange-50 p-2 text-center text-sm text-orange-700">매출반품전표 - 판매 후 반품 처리용</div>
                    <div className="grid grid-cols-5 gap-4">
                        ...
                        <div><label className="mb-1 block text-sm font-medium">거래처코드</label><input type="text" value={customerCode} onChange={(e) => setCustomerCode(e.target.value)} className="w-full rounded border px-3 py-2 text-sm" /></div>
